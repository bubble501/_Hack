...
class Procmon : boost::noncopyable
{
 ...
 public:
      ...
      ram_chart_(640, 100, 7200, 30)
  {
    ...
    //在构造函数内部指定收到HTTP请求后回调哪个函数
    //这里是指定在收到HTTP请求后回调onRequest函数
    //在onRequest中生成响应返回回去
 ...
 private:
  ...
  void onRequest(const HttpRequest& req, HttpResponse* resp)
  {
    ...
    */
    ...
    //如果请求URL是/cpu.png的话，那么就构造一个CPU使用率时间曲线返回回去
